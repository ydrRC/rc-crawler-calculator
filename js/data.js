/**
 * RC Crawler Calculator - Data Module
 * Contains all transmission and axle data
 */
...
/**
 * Get all transmission names
 * @returns {string[]} Array of transmission names
 */
...
/**
 * Get all axle names
 * @returns {string[]} Array of axle names
 */
 ...
 * @returns {string[]} Array of matching transmission names
 */
function searchTransmissions(keyword) {
    if (!keyword) return getTransmissionNames();
    const lowerKeyword = keyword.toLowerCase();
    return getTransmissionNames().filter(name => 
 ...
 * @param {string} keyword - Search keyword
 * @returns {string[]} Array of matching axle names
 */
function searchAxles(keyword) {
    if (!keyword) return getAxleNames();
    const lowerKeyword = keyword.toLowerCase();
    return getAxleNames().filter(name => 
        name.toLowerCase().includes(lowerKeyword)
    );
}